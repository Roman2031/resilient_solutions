...
class EditActionDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditActionDialog> createState() => _EditActionDialogState();
}

class _EditActionDialogState extends ConsumerState<EditActionDialog> {
  ...
  void initState() {
    ...
    _dueDate = widget.action.dueDate;
    _priority = widget.action.priority ?? 'medium';
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  value: _status,
                  dropdownColor: const Color(0xff012B5E),
                  style: const TextStyle(color: Colors.white),
                  decoration: InputDecoration(
                    filled: true,
                    fillColor: const Color(0xff012B5E),
